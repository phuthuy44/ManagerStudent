    ...
    internal class TeacherDAL : initConnect
    {
        ...
        public DataTable GetListTeacher()
        {
            ...
            string sql = @" SELECT
                ...
                GROUP BY
                    t.ID, t.teacherName, t.gender, t.birthday, t.email, t.phonenumber, t.address";
        ...
        public bool insertTeacher(Teacher teacher)
        {
            ...
            string sql = "INSERT INTO Teacher (teacherName,birthday,gender,address,email, phonenumber) " +
                         "Values(@Hoten,@NgaySinh,@gioitinh,@diaChi,@email,@soDienThoai)";
            SqlConnection conn = initConnect.ConnectToDatabase();
            try
            {
                SqlCommand cmd = new SqlCommand(sql, conn);
                ...
                /*cmd.Parameters.AddWithValue("@HinhAnh", "\\Image\\HocSinh\\" + teacher.Image);*/
                cmd.ExecuteNonQuery();
                return true;
            }
            catch (Exception ex)
