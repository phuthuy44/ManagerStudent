...
namespace ManagerStudent.StudentManagerDataSet3TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([ID] = @Original_ID) AND ((@IsNull_gender = 1" +
                " AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_name = 1 " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([gender], [name]) VALUES (@gender, @name);\r\nSELECT I" +
                "D, gender, name FROM Student WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [gender] = @gender, [name] = @name WHERE (([ID] = @Original_ID) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)));
SELECT ID, gender, name FROM Student WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, gender, name FROM dbo.Student";
        ...
        public virtual int Delete(int Original_ID, string Original_gender, string Original_name) {
        ...
        public virtual int Update(string gender, string name, int Original_ID, string Original_gender, string Original_name, int ID) {
            if ((gender == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string gender, string name, int Original_ID, string Original_gender, string Original_name) {
            return this.Update(gender, name, Original_ID, Original_gender, Original_name, Original_ID);
        }
    }
